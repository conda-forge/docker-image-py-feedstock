...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/docker-image-py-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11800&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/docker-image-py-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `docker-image-py` can be installed with:

```
conda install docker-image-py
```

It is possible to list all of the versions of `docker-image-py` available on your platform with:
